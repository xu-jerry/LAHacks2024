...
app.add_page(recipes, route="/recipes", on_load=State.check_login())
app.add_page(inventory, route="/inventory", on_load=State.check_login())
app.add_page(chat, route="/chat", on_load=State.check_login())
app.add_page(resources, route="/resources", on_load=State.check_login())
app.add_page(example_recipe, route="/baked_potato_recipe", on_load=State.check_login())
